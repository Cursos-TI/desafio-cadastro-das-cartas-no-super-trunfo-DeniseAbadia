...
int main (){
    ...
    printf ("\n*** Comparando as cartas (1 = Verdadeiro, 0 = Falso)- se o resultado for 1 - Carta 1 vence, se o resultado for O carta 2 vence ***\n");
    ...
    printf("Densidade Populacional (Carta 1 < Carta 2): %d\n", densidade_populacional1 < densidade_populacional2); // Lógica invertida
    printf("PIB per Capita (Carta 1 > Carta 2): %d\n", PIB_per_capita1 > PIB_per_capita2);
    printf("Super Poder (Carta 1 > Super Poder 2): %d\n", Super_Poder1 > Super_Poder2);
